...
export class CartApi {
  ...
  getCart(): Observable<CartResponseDto> {
    return this.http
      .get<GlobalApiResponse<CartResponseDto> | CartResponseDto>('/cart-service/api/cart')
  ...
  addItem(item: AddCartItemRequest): Observable<CartResponseDto> {
    return this.http
      .post<GlobalApiResponse<CartResponseDto> | CartResponseDto>('/cart-service/api/cart/items', item)
      .pipe(map((res) => ('data' in res && res.data ? res.data : (res as CartResponseDto))));
  }
  ...
  updateItemQuantity(productId: string | number, quantity: number): Observable<CartResponseDto> {
    return this.http
      .put<GlobalApiResponse<CartResponseDto> | CartResponseDto>(`/cart-service/api/cart/items/${productId}`, { quantity })
      .pipe(map((res) => ('data' in res && res.data ? res.data : (res as CartResponseDto))));
  }
  ...
  removeItem(productId: string | number): Observable<CartResponseDto | void> {
    return this.http
      .delete<GlobalApiResponse<CartResponseDto> | CartResponseDto | void>(
        `/cart-service/api/cart/items/${productId}`
      )
  ...
  clearCart(): Observable<void> {
    return this.http.delete<void>('/cart-service/api/cart');
  }

  /** POST merge guest cart items into user cart */
  mergeCart(payload: MergeCartRequest): Observable<CartResponseDto> {
    return this.http
      .post<GlobalApiResponse<CartResponseDto> | CartResponseDto>('/cart-service/api/cart/merge', payload)
      .pipe(map((res) => ('data' in res && res.data ? res.data : (res as CartResponseDto))));
  }
}
